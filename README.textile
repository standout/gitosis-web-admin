...
Edit the database configuration at config/database.yml and the application configuration located at config/application.example.yml and save it as config/application.yml
